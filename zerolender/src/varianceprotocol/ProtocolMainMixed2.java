...
public class ProtocolMainMixed2 {
	...
	public static void main(String[] args) 
	{
		...
		try {
			ProtocolMain.main(args);		//This only exists to have different command line arguments and distinguish the parties in Eclipse.
		}
		catch(Exception e)
		{
