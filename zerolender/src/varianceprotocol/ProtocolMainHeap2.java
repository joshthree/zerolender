...
public class ProtocolMainHeap2 {
	...
	public static void main(String[] args) 
	{
		...
		try {
			ProtocolMainHeap.main(args);		//This only exists to have different command line arguments and distinguish the parties in Eclipse.
		}
		catch(Exception e)
		{
